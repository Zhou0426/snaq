		...
		$("#submit").click(function(){
			...
			if($("#ff").form("validate")){
				...
				$("#ff").form("submit",{
					...
					queryParams:{'personId':principalId,'methods':methods,'inconformityItemid':rows[0].id},
					success:function(data){
	...
	<form method="post" id="ff">
		<table>
			...
			<tr id="lastdate" style="display:none">
				...
				<td>
					<input name="correctDeadline" id="correctDeadline" class="easyui-datetimebox" style="width: 190px">
				</td>
			</tr>
			<tr>
