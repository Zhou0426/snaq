		...
		$('#tb').textbox({    
    		...
    		iconCls:'icon-man', 
   		 	...
   		 	onChange:function(newValue, oldValue){
   		 		if(newValue!=""){
   		 			$('#cc2').combogrid('grid').datagrid('load',{q:newValue,'departmentSn':'1'});
   		 		}
   		 	}
		});
		//专业
		...
		$("#submit").click(function(){
			...
			if($("#ff").form("validate")){
				...
				$("#ff").form("submit",{
					...
					queryParams:{ids:personIds,specialityIds:sIds},
...
<body>
	...
	<form method="post" id="ff">
		...
		<input name="checkerFrom" value="高层管理人员" type="hidden">
		<table>
			<tr>
		...
		<div id="ft" style="margin-top: 35px; text-align: center;">
