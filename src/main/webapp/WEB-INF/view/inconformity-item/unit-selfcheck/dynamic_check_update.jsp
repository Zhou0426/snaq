    		...
    		iconCls:'icon-man', 
   		 	...
   		 	onChange:function(newValue, oldValue){
   		 		if(newValue!=""){
   		 			...
   		 			$('#cc7').combogrid('grid').datagrid('load',{q:newValue,advancedSearch:false,'departmentSn':departmentSn});
   		 		}
   		 	}
		});
		...
		$("#submit").click(function(){
			...
			if($("#ff").form("validate")){
				...
				$("#ff").form("submit",{
					...
					queryParams:{'ids':personIds,'methods':methods,'inconformityItemid':rows[0].id,'personId':principalId},
					success:function(data){
