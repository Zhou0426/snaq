						...
						if(status=="ok"){
							...
							$.messager.confirm('确认对话框', msg, function(r){
								if (r){
									$('#ff').form('submit', {
										url:'${pageContext.request.contextPath}/inconformity/item/unsafeconditionAction_save.action',
										queryParams:{'personId':principalId,'ids':personIds,isConfirm:"true",'methods':methods,"checkType":"动态检查","checkerFrom":"单位"},
	...
	<form method="post" id="ff">
		<table>
			<tr>
				...
				<td width="200px">
					<input id="datebox" name="checkDateTime" class="easyui-datetimebox" style="width:190px">
				</td>
			</tr>
			<tr>
				...
				<td>	
					<input name="checkLocation" class="easyui-textbox" data-options="required:true" style="width:190px;">				
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3">
					<input id="correctProposal" name="correctProposal" class="easyui-textbox" style="width:530px;height:44px;" 
