	...
	<script type="text/javascript">
		$(function(){
			...
			$("#ok_btn").click(function(){
					...
					if($('#ff').form("validate")){
						$('#ff').form('submit', {
							url:'${pageContext.request.contextPath}/latenthazard/latenthazardAction_audit',
							...
							success: function(result){
								...
								if(data.message=="success"){
									...
									//关闭当前页面
									parent.$('#win').window("close");
									parent.$.messager.alert('警告','审核操作失败，请检查后重新操作！');
								}
								//刷新dg
	...
	<form id="ff" method="post" enctype="multipart/form-data">
	    <div>
	        ...
	        <select id="auditedStatus" name=auditedStatus class="easyui-combobox" 
					data-options="required:true,panelWidth: 200,panelHeight:'auto',editable:false" 
					style="width:200px">
	    ...
	    <div id="loadFile" class="div-height">
			<label for="fb">选择文件：&emsp;</label>
			<input name="upload" id="fb" type="text">
		</div>
	    <div>
