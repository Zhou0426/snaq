	...
	<script type="text/javascript">
		...
		$(function(){
			var row = parent.$('#dg').datagrid("getSelections");
	 		var departmentSn = row[0].departmentSn;
	 		var standardSn = parent.$('#standard').combobox('getValue');
	 		var standardIndexSn = parent.$('#standardIndex').combotree('getValue');
	 		
	 		$('#dg').datagrid({
	 			url:'${pageContext.request.contextPath}/unsafeCondition/query/queryAction_showStandardIndexData',
				idField: 'id',
	            toolbar:'#query',
	            queryParams:{'departmentSn' : departmentSn, 'standardSn' : standardSn, 'indexSn' : standardIndexSn},
