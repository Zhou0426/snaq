	...
	$(function(){
		...
		$("#submit").click(function(){
			...
			if($("#ff").form("validate")){
				//ajax
				$('#ff').form("submit",{
					url:'${pageContext.request.contextPath}/customize/department/unsafeActDeductionPointAction_update',
					queryParams:{type:1,id:row.id,departmentSn:row.departmentSn},  
