...
<script type="text/javascript">
	...
	function deleteit(index)
	{
		...
		$.messager.confirm('删除确认','您确定要删除选中的数据吗？',function(r)
		{
			...
			{
				//发送请求提交删除信息
                $.post("${pageContext.request.contextPath}/interior/work/interiorWork_deleteInteriorAttachment",{'id' : ids},function(result){
	...
	$(function(){
		...
		var interiorWorkSn = parentrow.interiorWorkSn;
		$("#dg").datagrid({
			...
			toolbar:[{
				...
				text:"<form id='upload' method='post' enctype='multipart/form-data'>"
						...
						+ "<input name='interiorWorkSn' type='hidden'/>"
		...
		$("#submit").click(function()
		{
				...
				if($("#upload").form("validate"))
				{
					...
					$('#upload').form('submit',
					{
						url:'${pageContext.request.contextPath}/interior/work/interiorWork_addInteriorAttachment',
