...
<body>
	...
	<table id="dg"></table>
	<!-- 未遂事件填写窗口-->
	<div id="win" class="easyui-window" title="未遂事件信息" closed="true" style="width: 950px; height: 400px; padding: 5px;" data-options="onClose:function(){$('#form').form('reset');}">
		<br />
		<form id="form" method="post">
			<div style="margin-left: 20px">
				<div style="diapaly: inline">
					 <input name="nearMissSn" hidden/>
					 <label style="padding-right: 10px">&emsp;事件类型：</label>
					 <input id="nearMissType" required="true" data-options="panelHeight:'300px',editable:false" name="nearMissTypeSn" />
					<label style="padding-right: 10px">&emsp;事件名称：</label>
					 <input name="eventName" class="easyui-textbox easyui-validatebox" data-options="required:true,missingMessage:'请输入未遂事件名称'"> 
					 <label style="padding-right: 10px">&emsp;发生日期：</label> 
					 <input name="happenDate" class="easyui-datebox" data-options="required:true,missingMessage:'请输入未遂事件发生日期',editable:false" />
					 <br/><br/>
					 <label style="padding-right: 10px">&emsp;发生地点：</label> 
					 <input name="happenLocation" class="easyui-textbox easyui-validatebox" data-options="required:true,missingMessage:'请输入发生地点'" /> 
					 <label style="padding-right: 10px">&emsp;风险等级：</label> 
					 <select name="riskLevel" class="easyui-combobox" data-options="panelHeight:'auto',editable:false" style="width: 175px">
						<option value="一般风险">一般风险</option>
						<option value="中等风险">中等风险</option>
						<option value="重大风险">重大风险</option>
					 </select> 
					 <label style="padding-right: 10px">&emsp;发生区队：</label> 
					 <input value="${sessionScope['departmentName']}" readonly="true" iconCls="icon-lock" class="easyui-textbox" data-options="panelHeight:'auto'"/>					 
					 <br/>
				</div><br />
