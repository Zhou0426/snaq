...
<script type="text/javascript">
	$(function(){
		...
		$.ajax({
            ...
            data: {'year':year,'month':value,'departmentSn':rows[0].departmentSn,'type':0},
            dataType: "json",
		...
		$('#cc').calendar({  
			...
			onSelect: function(date){
 				parent.$('#child-win').window({    
				    ...
				    modal:true,
				    cache:false,
				    content:'<iframe src="${pageContext.request.contextPath}/security/appraisals/unitmonth-detail" frameborder="0" width="100%" height="100%"/>'
				});
			}
