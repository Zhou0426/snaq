...
<script type="text/javascript">
	...
	$(function(){
		...
		var personData=[];
		for(var i=0;i<rows2[0].auditors.num;i++){
			var personIds=rows2[0].auditors.Ids.split(",");
			var personNames=rows2[0].auditors.personNames.split(",");
...
//				console.log(row);
		...
		//检查人员回显
		if(rows[0].checkersId != "无"){
			var chId=rows[0].checkersId.split(",");
				...
				$("#ff").form("submit",{
					...
					success:function(data){
						...
						if(result=="login"){
							...
							parent.$.messager.alert('我的消息','修改成功！');	
	 						$("#ff").form("reset");
	...
	<form method="post" id="ff">
		...
		<table>
			<tr class="tr-height">
				...
				<td>
					<input id="cc6" name="departmentSn" style="width: 200px;">
				</td>
