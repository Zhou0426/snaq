...
<script type="text/javascript">
	$(function(){
		...
		var id=-1;
		$('#dg').datagrid({
			url:'${pageContext.request.contextPath}/system/audit/systemScoreDetailsAction_query',
			queryParams:{'auditSn':rows2[0].auditSn,'departmentSn':rows2[0].auditedDepartment.departmentSn,'indexSn':rows1.indexSn},
			fit:true,
			stript:true,
			nowrap:true,
			loadMsg:'请等待',
