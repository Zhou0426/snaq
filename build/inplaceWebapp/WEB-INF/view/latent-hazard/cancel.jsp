...
<head>
		...
		<script type="text/javascript">
			$(function(){
				$('#dg').datagrid({
					url: '${pageContext.request.contextPath}/latenthazard/latenthazardAction_showCancelData',
					idField: 'id',
		            //title:'重大隐患上报',
		            toolbar:'#toolbar',
					...
					columns:[[
					          ...
					          {field:'status',title:'状态',width:50,align:'center',
					        	  formatter:function(value,row,index){
					        		  if( value == "已审核" || value == "已上报" ){
									 	  return "未销号<a class='iconBtn' href='javascript:;' onclick=cancelLatentHazard("+row.id+") name='btn'></a>";
					        		  }else{
					        			  return value;
					        		  }
								  }
			...
			function cancelLatentHazard(event){
				$.messager.confirm('确认','一旦销号将无法修改，您确认要销号吗？',function(r){
				    if (r){
				    	$.post("${pageContext.request.contextPath}/latenthazard/latenthazardAction_cancelLatentHazard",{id:event},function(result){
