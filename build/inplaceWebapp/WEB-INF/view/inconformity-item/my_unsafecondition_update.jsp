...
<script type="text/javascript">
	...
	$(function(){
		...
		if(rows[0].checkType!="定期检查" && rows[0].checkType!="专项检查"){
			showMethod=false;
		}
		...
		if(rows[0].checkerFrom=="单位"){
			$.ajax({
	            ...
	            success: function(data){
					...
					if(cd==false){
						var dSn=rows2[0].checkedDepartment.departmentSn;
						var dName=rows2[0].checkedDepartment.departmentName;
		...
		//专业回显
		var num=rows2[0].checkers.num;
		if(num>0){
			var chId=rows2[0].checkers.personIds;
			$('#cc7').combobox('setValues',chId);
		}
		//指标回显
		...
		$("#submit").click(function(){
			...
			if($("#ff").form("validate")){
				...
				$("#ff").form("submit",{
					...
					queryParams:{'personId':principalId,'ids':personIds,'methods':methods,'inconformityItemid':rows2[0].id,},
					success:function(data){
	...
	<form method="post" id="ff">
		<table>
			...
			<tr>
				...
				<td colspan="3">
					<input id="cc7" class="easyui-combobox" style="width:530px;">
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3">
					<input name="indexId" id="cc3" style="width: 530px;" class="easyui-combotree"/>
				</td>
			</tr>
			<tr>
				<td></td>
			...
			<tr id="scc1">
				...
				<td colspan="3">
					<input  id="cc1" class="easyui-combogrid" style="width: 530px;"/>
				</td>
			</tr>
			...
			<tr id="scc4">
				...
				<td colspan="3">
					<input name="hazardSn" id="cc4" class="easyui-combogrid" style="width:530px;"/>
				</td>
			</tr>
			<tr>
