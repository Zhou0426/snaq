...
<script type="text/javascript">
	...
	$(function(){
		...
		var specialCheckSn="";
		var checkType=rows[0].checkType;
		var checkerFrom=rows[0].checkerFrom;
		if(checkType=="定期检查"){
		...
		$("#submit").click(function(){
			...
			if($("#ff").form("validate")){
				...
				$("#ff").form("submit",{
					...
					queryParams:{'ids':personIds,'specialCheckSn':specialCheckSn,'periodicalCheckSn':periodicalCheckSn,'checkType':checkType,'checkerFrom':checkerFrom},
