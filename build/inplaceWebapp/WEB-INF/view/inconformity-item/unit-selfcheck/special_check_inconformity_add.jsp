		...
		$("#submit").click(function(){
			...
			if($("#ff").form("validate")){
				...
				$("#ff").form("submit",{
					...
					queryParams:{'personId':principalId,'ids':personIds,isConfirm:"false",'specialCheckSn':rows[0].specialCheckSn,'methods':methods,"checkType":"专项检查",'checkerFrom':'单位'},
					success:function(data){
						...
						if(status=="ok"){
							...
							$.messager.confirm('确认对话框', msg, function(r){
								if (r){
									$('#ff').form('submit', {
										url:'${pageContext.request.contextPath}/inconformity/item/unsafeconditionAction_save.action',
										queryParams:{'personId':principalId,'ids':personIds,isConfirm:"true",'specialCheckSn':rows[0].specialCheckSn,'methods':methods,"checkType":"专项检查",'checkerFrom':'单位'},
