...
<script type="text/javascript">
	...
	$(function(){
		...
		var periodicalCheckSn = rows[0].periodicalCheckSn;
		var pIds="";
		...
		$("#submit").click(function(){
			...
			if($("#ff").form("validate")){
				...
				$("#ff").form("submit",{
					...
					queryParams:{'ids':personIds,'periodicalCheckSn':periodicalCheckSn},
...
<body>
	...
	<form method="post" id="ff">
		...
		<input type="hidden" value="定期检查" name="checkType">
		<input type="hidden" value="单位" name="checkerFrom">
		<table>
			<tr class="tr-height">
