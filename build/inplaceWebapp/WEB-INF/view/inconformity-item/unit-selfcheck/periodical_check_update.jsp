    		...
    		iconCls:'icon-man', 
   		 	...
   		 	onChange:function(newValue, oldValue){
   		 		if(newValue!=""){
		 			...
		 			$('#cc2').combogrid('grid').datagrid('load',{q:newValue,advancedSearch:false,'departmentSn':departmentSn});
   		 		}
   		 	}
		});
	...
	<input name="id" type="hidden"/>
		<table>
			...
			<tr>
				...
				<td class="label">
					<input id="radio1" type="radio" name="periodicalCheckType" value="周检" checked>周检
