...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#submit").click(function(){
			...
			//将检查人员数组处理一下
			var personIds="";
			var cc7=$('#cc7').combobox('getValues');
			...
			if($("#ff").form("validate")){
				...
				$("#ff").form("submit",{
					...
					queryParams:{'personId':principalId,'ids':personIds,isConfirm:"false",'periodicalCheckSn':rows[0].periodicalCheckSn,'methods':methods,'checkType':'定期检查','checkerFrom':'业务部门'},
					success:function(data){
						...
						if(status=="ok"){
							...
							$.messager.confirm('确认对话框', msg, function(r){
								if (r){
									$('#ff').form('submit', {
										url:'${pageContext.request.contextPath}/inconformity/item/unsafeconditionAction_save.action',
										queryParams:{'ids':personIds,isConfirm:"true",'periodicalCheckSn':rows[0].periodicalCheckSn,'methods':methods, "checkType":'定期检查','checkerFrom':'业务部门'},
	...
	<form method="post" id="ff">
		<table>
			...
			<tr>
				...
				<td colspan="3">
					<input id="cc7" style="width:200px;">
				</td>
			</tr>
			<tr>
