 ...
 * Generated at: 2017-07-22 06:55:49 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\tvar url ='");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/person/exportPerson?departmentSn=' + $('#cc').combotree('getValue');\r\n");
      out.write("\t\t\t\t\tif( !$('#includedeleted').switchbutton('options').checked==true ){\r\n");
      out.write("\t\t\t\t\t\turl = url + \"&deleteornot=0\";\r\n");
      out.write("\t\t\t\t\t}\r\n");
      ...
      out.write("\t    \t\t\t\t$.messager.confirm('提示','您确定要恢复该人员吗?',function(r){\r\n");
      out.write("\t    \t\t\t\t\tif(r){\r\n");
      out.write("\t    \t\t\t\t\t\t$.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/person/cancelDelete',{changeId:row.id},function(data){\r\n");
      out.write("\t    \t\t\t\t\t\t\t$.messager.alert('提示',data.substring(1,data.length-1));\r\n");
      out.write("\t    \t\t\t\t\t\t\t$('#dg').datagrid('reload');\r\n");
      ...
      out.write("    \t\t//console.log(row.deleted);\r\n");
      ...
      out.write("                  {field:'personName',title:'人员姓名',width:60}, \r\n");
      out.write("                  {field:'cellphoneNumber',title:'电话号码',width:80},\r\n");
      out.write("                  {field:'implDepartmentName',title :'贯标单位',width :100},\r\n");
      out.write("                  {field:'department',title:'所属部门',width:100}, \r\n");
      out.write("                  {field:'postLevell',title:'岗位等级',width:100},    \r\n");
      out.write("                  {field:'gender',title:'性别',width:30},\r\n");
      out.write("                  {field:'education',title:'学历',width:30},\r\n");
      out.write("                  {field:'birthday',title:'出生日期',width:80,formatter: formatDatebox},\r\n");
